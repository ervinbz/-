...
if __name__ == '__main__':
    weibo_id_list = ['5026835337578367', ]
    max_page = 500  # 爬取最大页数
    comment_file = '小米汽车_今天上午09:20.csv'
    # 如果结果文件存在，先删除
