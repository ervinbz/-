...
if __name__ == '__main__':
    weibo_id_list = ['5026276652089976', ]
    max_page = 500  # 爬取最大页数
    comment_file = '小米汽车_一份小米汽车北京车展攻略评论.csv'
    # 如果结果文件存在，先删除
